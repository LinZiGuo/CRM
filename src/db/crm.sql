...
CREATE TABLE `cst_customer`(
	`cust_id` bigint(32) NOT NULL AUTO_INCREMENT COMMMENT '客户Id',
...
CREATE TABLE `base_dict`(
	...
	`dict_sort` int(10) NOT NULL COMMENT '排序字段',
...
('12','004','年营业额','1-100万',NULL,1,'1',NULL),
